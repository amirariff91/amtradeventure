    ...
    <>
      ...
      >
        <div className="container mx-auto px-4 py-4">
          <div className="glass rounded-full shadow-lg shadow-black/5 backdrop-blur-md bg-white/90 dark:bg-neutral-800/90 border border-neutral-200/50 dark:border-neutral-700/50">
            <nav className="flex items-center justify-between px-6 py-3">
              <a 
                href="#hero" 
                className="text-[#0088cc] font-semibold text-lg hover:scale-105 transition-transform focus:outline-none focus:ring-2 focus:ring-[#0088cc] focus:ring-offset-2 rounded-lg relative w-[120px] h-[48px]"
              ...
              {/* Mobile menu button */}
              <button
                className="md:hidden p-2 rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-700 transition-colors focus:outline-none focus:ring-2 focus:ring-[#0088cc] focus:ring-offset-2"
              ...
              <ul className="hidden md:flex items-center gap-6" role="menubar">
                {navItems.map((item) => (
                  <li key={item.name} role="none">
                    ...
                    >
                      {item.name}
                      {activeSection === item.href.slice(1) && (
                        <span className="absolute bottom-0 left-1/2 right-1/2 h-0.5 bg-gradient-to-r from-[#0088cc] to-[#00cc88] transform -translate-x-1/2 scale-x-100 transition-all duration-300 group-hover:scale-x-110" />
                      )}
                    </a>
                  </li>
                ))}
                <li role="none">
                  <a 
                    href="#contact"
                    className="btn btn-primary inline-flex items-center gap-2 group px-6 py-2.5 text-sm"
            ...
            <div
              ...
              } overflow-hidden backdrop-blur-md bg-white/95 dark:bg-neutral-800/95 rounded-2xl mx-4 my-2 shadow-lg border border-neutral-200/50 dark:border-neutral-700/50`}
              role="menu"
